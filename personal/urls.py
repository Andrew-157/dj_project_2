...
urlpatterns = [
    ...
    path('personal/articles/publish/',
         views.PublishArticleThroughPersonalPage.as_view(), name='publish-article-personal'),
    path('personal/articles/list/publish/',
         views.PublishArticleThroughArticlesList.as_view(), name='publish-article-list'),
